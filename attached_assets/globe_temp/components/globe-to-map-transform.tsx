...
export function GlobeToMapTransform() {
  ...
  useEffect(() => {
    ...
    svg
      ...
      .attr("fill", (d: any) => {
        // Brazil's ISO code is "BRA" or name is "Brazil"
        const isBrazil = d.properties?.name === "Brazil" || d.properties?.iso_a3 === "BRA"
        return isBrazil ? "#009b3a" : "none"
      })
      .attr("stroke", "#cccccc")
      .attr("stroke-width", 1.0)
      .attr("opacity", (d: any) => {
        const isBrazil = d.properties?.name === "Brazil" || d.properties?.iso_a3 === "BRA"
        return isBrazil ? 0.5 : 1.0
      })
  ...
  // Removed handleReset function as Reset button is removed
  ...
  return (
    <div className="relative flex items-center justify-center w-full h-full">
      ...
      />
      {/* Removed buttons div and all instructions - user discovers interaction naturally */}
    </div>
  )
}
