      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Onde tudo comeca. Musica, arte, design, video e fotografia. 
              Transformamos ideias em obras que permanecem.
            </p>
          </div>
          
          <div>
            <h3 className="text-sm font-semibold mb-4 uppercase tracking-wider">Navegacao</h3>
            <ul className="space-y-2 text-gray-400 text-sm">
              <li><span className="hover:text-white cursor-pointer transition-colors">Inicio</span></li>
        ...
        <div className="pt-6 border-t border-gray-800 text-center">
          <p className="text-gray-500 text-sm">
            {new Date().getFullYear()} Geneseez. Criando desde o inicio.
          </p>
        </div>
      </div>
    </footer>
