...
const Origem: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-8 z-20 flex flex-col sm:flex-row items-center gap-4">
        <button 
          onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
          className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-gray-300 text-gray-400 transition-all duration-300 hover:border-[#1DB954] hover:text-[#1DB954] hover:bg-[#1DB954]/10 group"
        >
          <svg 
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-gray-300 text-gray-400 transition-all duration-300 hover:border-[#FF0000] hover:text-[#FF0000] hover:bg-[#FF0000]/10 group"
        >
          <Youtube className="w-5 h-5 transition-colors duration-300 group-hover:text-[#FF0000]" />
